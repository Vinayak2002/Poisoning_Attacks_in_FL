# Poisoning Attack with No defense
...
for comm_round in range(fl_rounds):
    ...
    for (X_test, Y_test) in test_batched:
        global_acc, global_loss = test_model(X_test, Y_test, global_model, comm_round, "poisoning_no_defense_global.txt")
...
for (X_test, Y_test) in test_batched:
    SGD_acc, SGD_loss = test_model(X_test, Y_test, SGD_model, 1, 'poisoning_no_defense_no_fl.txt.txt')
