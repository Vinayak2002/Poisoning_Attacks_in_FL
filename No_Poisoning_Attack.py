# No Poisoning Attack, Vanilla Federated Learning Model
...
for comm_round in range(fl_rounds):
    ...
    for (X_test, Y_test) in test_batched:
        global_acc, global_loss = test_model(X_test, Y_test, global_model, comm_round, 'no_poisoning_global.txt')
...
for (X_test, Y_test) in test_batched:
    SGD_acc, SGD_loss = test_model(X_test, Y_test, SGD_model, 1, 'no_poisoning_no_fl.txt')
